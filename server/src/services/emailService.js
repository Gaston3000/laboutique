...
export async function sendOrderConfirmationEmail(userEmail, orderDetails) {
  try {
    const { orderId, customerName, totalArs, items, deliveryAddress } = orderDetails;
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 20px 0; font-size: 16px; color: #666666; line-height: 1.6;">
                Tu pedido ha sido confirmado exitosamente. En breve comenzaremos a prepararlo para su envío.
              </p>
              
              <!-- Order Summary Box -->
              <table style="width: 100%; border: 2px solid #e5e7eb; border-radius: 8px; margin: 30px 0; overflow: hidden;">
                <tr style="background-color: #f9fafb;">
                  <td style="padding: 15px 20px; font-weight: bold; color: #1f2937; border-bottom: 1px solid #e5e7eb;">
                    Número de Pedido
                  </td>
                  <td style="padding: 15px 20px; text-align: right; color: #1a4ac8; font-weight: bold; border-bottom: 1px solid #e5e7eb;">
                    #${orderId}
                  </td>
                </tr>
                <tr>
                  <td style="padding: 15px 20px; font-weight: bold; color: #1f2937;">
                    Total
                  </td>
                  <td style="padding: 15px 20px; text-align: right; color: #059669; font-size: 20px; font-weight: bold;">
              ...
              <table style="width: 100%; margin-bottom: 30px;">
                ${items.map(item => `
                  <tr>
                    ...
                    <td style="padding: 12px 0; text-align: center; color: #6b7280; border-bottom: 1px solid #f3f4f6;">
                      x${item.quantity}
                    </td>
                    <td style="padding: 12px 0; text-align: right; color: #1f2937; font-weight: 500; border-bottom: 1px solid #f3f4f6;">
