...
export default function WelcomeDiscountModal({ isOpen, onClose, expiresAt }) {
  ...
  return (
    <div className="modal-backdrop" role="presentation" onClick={onClose}>
      ...
      >
        ...
        <div className="welcome-discount-content">
          ...
          <div className="welcome-discount-timer-box">
            <div className="timer-label" style={{display: 'flex', alignItems: 'center', gap: '6px', justifyContent: 'center'}}>
              <svg viewBox="0 0 24 24" style={{width: '18px', height: '18px', display: 'block'}}>
                ...
                <path className="clock-animated" fill="currentColor" fillRule="evenodd" d="m12.6 11.503l3.891 3.891l-.848.849L11.4 12V6h1.2z" style={{transformOrigin: '12px 12px'}}/>
              </svg>
              Tiempo disponible
            </div>
